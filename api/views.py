...
s3 = {
    ...
    "city": "Rabat",
    "country": "morocco",
    "desc": "It was built in 1983 and was the home ground of AS FAR. It was used mostly for football matches and it also staged athletics. The stadium had a capacity of 50,000 people. From 2008 until 2023, it has hosted the Meeting International Mohammed VI d'Athlétisme de Rabat. It was a confirmed venue for the 2015 Africa Cup of Nations until Morocco was stripped of its hosting rights. Morocco asked for the Africa Cup of Nations to be postponed because of fear of the Ebola pandemic that was affecting several African countries at the time. The country was then ruled out as a host of the international competition.",
    "cost": 0,
    "picture": r,
    "map": "https://maps.app.goo.gl/4eXq1ZLe17Q6siYUA",
    "latitude": 33.9598463,
    "longitude": -6.8890037,
}
s3_path = [
    "C:/Users/pp/Desktop/devjam/api/images/rabat/main.jpeg",
    "C:/Users/pp/Desktop/devjam/api/images/rabat/s1.jpg",
    "C:/Users/pp/Desktop/devjam/api/images/rabat/s2.jpg",
    "C:/Users/pp/Desktop/devjam/api/images/rabat/s3.jpg",
    "C:/Users/pp/Desktop/devjam/api/images/rabat/s4.jpg",
]
...
s5 = {
    ...
    "city": "Agadir",
    "country": "morocco",
    "desc": "The competition for design of a new major stadium in Agadir was launched back in the twentieth century, when Morocco was bidding to become the first ever African host of the FIFA World Cup. Already then the Italian-Moroccan consortium of Gregotti and Benkirane were awarded the job. That same design, though upgraded, was submitted as Morocco's bid for the 2010 World Cup, having failed for the 2006 edition. To increase Morocco's chances ground clearing began in 2003. That may have been enough to win some votes and get Morocco to the final vote, but in May 2004 FIFA chose South Africa over Morocco by 14 votes to 10. This effectively ruined the Maghreb country's chances for at least two decades as continental rotation of the World Cup was dropped soon after (in 2007) and bringing it back to Africa became a dim prospect.",
    "cost": 860,
    "picture": a,
    "map": "https://maps.app.goo.gl/juMDPN1BSyojqkNJ6",
    "latitude": 30.427483,
    "longitude": -9.54025,
}
s5_path = [
    "C:/Users/pp/Desktop/devjam/api/images/agadir/main.jpg",
    "C:/Users/pp/Desktop/devjam/api/images/agadir/s1.jpg",
    "C:/Users/pp/Desktop/devjam/api/images/agadir/s2.jpg",
    "C:/Users/pp/Desktop/devjam/api/images/agadir/s3.jpg",
    "C:/Users/pp/Desktop/devjam/api/images/agadir/s4.jpg",
]
...
s6 = {
    ...
    "city": "Fes",
    "country": "morocco",
    "desc": "According to initial plans, works on the new central stadium for Fez were to start in early 1990s, but groundbreaking was delayed for almost 2 years, starting eventually in 1994. As if this wasn't enough, the delays were growing further as time went by, resulting by the stadium not being ready for the 1997 Cup of Nations, as was planned. It wasn't until 2003 that the construction ended, being expanded in the process by 5,000 additional seats compared to the 1992 design. Still, even after delivery it waited four years to be opened. The free-for-all exhibition game between FAR Rabat and Rachad Bernoussi was played in front of full stands in November 2007.",
    "cost": 0,
    "picture": f,
    "map": "https://maps.app.goo.gl/SdNbXR3QpWqsjNtd7",
    "longitude": -5.0410351,
    "latitude": 34.0290527,
}
s6_path = [
    "C:/Users/pp/Desktop/devjam/api/images/fes/main.jpg",
    "C:/Users/pp/Desktop/devjam/api/images/fes/s1.jpg",
    "C:/Users/pp/Desktop/devjam/api/images/fes/s2.avif",
    "C:/Users/pp/Desktop/devjam/api/images/fes/s3.jpg",
    "C:/Users/pp/Desktop/devjam/api/images/fes/s4.jpg",
]
...
def add_cities():
    ...
    for i in all_stad:
        ...
        res = Cities(
            name=c,
            desc=descr[sym[c]],
            population=pop[sym[c]],
            creation_date=date[sym[c]],
            transport=transport[sym[c]],
            stad_id=stadiums.objects.get(id=i["id"]),
        )
        res.save()
...
def add_places():
    for j in places:
        ...
        for i in places[j]:
            pl = place(
                name=places[j][i]["name"],
                desc=places[j][i]["desc"],
                location=places[j][i]["location"],
                image=places[j][i]["img"],
                city_id=ct,
            )
            pl.save()
...
def add_dishes():
    for j in dishes:
        ...
        for i in dishes[j]:
            pl = dishe(
                name=dishes[j][i]["name"],
                desc=dishes[j][i]["desc"],
                image=dishes[j][i]["img"],
                city_id=ct,
            )
            pl.save()
        ...
        res = [
            {
                ...
                "stadium": {"id": r.stad_id.id, "name": r.stad_id.name},
                "image": r.image,
            }
            for r in Cities.objects.all()
        ]
        return Response(res)
